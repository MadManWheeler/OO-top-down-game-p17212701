...
P2::P2(b2World * world, const sf::Vector2f& position, const float radius, const float orientation, b2Vec2 VEL2)
{
	b2BodyDef l_bodyDef;
...
void P2::draw(sf::RenderTarget & target, sf::RenderStates states) const
{
